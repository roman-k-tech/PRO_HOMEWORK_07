...
public class MyController {
    ...
    public String onAddPhoto(Model model, @RequestParam MultipartFile photo)
    {
        ...
        catch (IOException e) { throw new PhotoErrorException(); }
    }
    ...
    @RequestMapping(value = "/multyDelete", method = RequestMethod.POST)
    public String onMultyDelete (@RequestParam("id") List<Long> ids)
    {
        for (Long id : ids){
            photos.remove(id);
        }
